...
INSERT INTO `admin` (`AdminID`, `Usuario`, `Contraseña`) VALUES
(1, 'EstelaAd123', '552134524');
...
CREATE TABLE `boleto` (
  `BoletoID` int(5) NOT NULL,
  `NombreBoleto` varchar(100) NOT NULL,
  `InicioDestino` varchar(100) NOT NULL DEFAULT 'Terminal de Posadas Misiones',
  `Precio` float NOT NULL,
  `TipoboletoID` int(5) DEFAULT NULL,
  `HorarioID` int(5) DEFAULT NULL,
  `CantidadPersonas` int(100) NOT NULL,
  `localID` int(5) DEFAULT 1,
  `IdaYvuelta` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `destino` (
  `DestinoID` int(5) NOT NULL,
  `Nombre` varchar(1000) NOT NULL,
  `LocalidadID` int(5) DEFAULT NULL,
  `BoletoID` int(5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `empresa` (
  ...
  `Nombre` varchar(1000) NOT NULL,
  `PaletaID` int(10) DEFAULT NULL,
  `ImagenPrincipal` varchar(1000) NOT NULL,
  `ImagenI` varchar(1000) NOT NULL,
  `ImagenII` varchar(1000) NOT NULL,
  `ImagenIII` varchar(1000) NOT NULL,
  `IconoEmpresa` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `horario` (
  `HorarioID` int(5) NOT NULL,
  `Horario` time NOT NULL,
  `EmpresaID` int(5) DEFAULT NULL,
...
CREATE TABLE `local` (
  ...
  `FotoI` varchar(1000) NOT NULL,
  `FotoII` varchar(1000) NOT NULL,
  `FotoIII` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `local` (`LocalID`, `Nombre`, `Ubicacion`, `Telefono`, `Instagram`, `FotoI`, `FotoII`, `FotoIII`) VALUES
(1, 'Agencia 43 44', '', '', '', '', '', '');
...
CREATE TABLE `localidad` (
  ...
  `ProvinciaID` int(5) DEFAULT NULL,
...
INSERT INTO `localidad` (`LocalidadID`, `ProvinciaID`, `Localidad`) VALUES
(1, 1, '25 de Mayo'),
(2, 1, '3 de febrero'),
(3, 1, 'A. Alsina'),
...
CREATE TABLE `paleta` (
  `PaletaID` int(11) NOT NULL,
  `Paleta` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tipoboleto` (
  `TipoBoletoID` int(5) NOT NULL,
  `Tipo` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `tipoboleto`
--

INSERT INTO `tipoboleto` (`TipoBoletoID`, `Tipo`) VALUES
(1, 'Pasajero'),
(2, 'Encomienda');
...
ALTER TABLE `boleto`
  ...
  ADD KEY `TipoDestinoID` (`TipoboletoID`,`HorarioID`),
...
--
ALTER TABLE `local`
  MODIFY `LocalID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `localidad`
--
ALTER TABLE `localidad`
  MODIFY `LocalidadID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2074;

--
-- AUTO_INCREMENT de la tabla `provincia`
--
ALTER TABLE `provincia`
  MODIFY `ProvinciaID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT de la tabla `tipoboleto`
--
ALTER TABLE `tipoboleto`
  MODIFY `TipoBoletoID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `boleto`
  ADD CONSTRAINT `boleto_ibfk_2` FOREIGN KEY (`TipoboletoID`) REFERENCES `tipoboleto` (`TipoBoletoID`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `boleto_ibfk_4` FOREIGN KEY (`localID`) REFERENCES `local` (`LocalID`),
  ADD CONSTRAINT `boleto_ibfk_5` FOREIGN KEY (`HorarioID`) REFERENCES `horario` (`HorarioID`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `destino`
--
ALTER TABLE `destino`
  ADD CONSTRAINT `destino_ibfk_1` FOREIGN KEY (`LocalidadID`) REFERENCES `localidad` (`LocalidadID`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `destino_ibfk_2` FOREIGN KEY (`BoletoID`) REFERENCES `boleto` (`BoletoID`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `empresa`
--
ALTER TABLE `empresa`
  ADD CONSTRAINT `empresa_ibfk_1` FOREIGN KEY (`PaletaID`) REFERENCES `paleta` (`PaletaID`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `horario`
--
ALTER TABLE `horario`
  ADD CONSTRAINT `horario_ibfk_1` FOREIGN KEY (`EmpresaID`) REFERENCES `empresa` (`EmpresaID`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `localidad`
--
ALTER TABLE `localidad`
  ADD CONSTRAINT `localidad_ibfk_1` FOREIGN KEY (`ProvinciaID`) REFERENCES `provincia` (`ProvinciaID`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
